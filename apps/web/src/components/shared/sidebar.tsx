    ...
    return (
        <aside className="fixed left-0 top-0 z-100 hidden h-screen w-72 flex-col border-r border-sky-100 bg-white px-6 py-8 lg:flex">
            <div className="mb-10 flex items-center gap-3 px-2">
                ...
                <span className="font-display text-xl font-bold tracking-tight text-slate-900">SmartInventory</span>
            </div>
                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            ...
                            href={item.href}
                            className={cn(
                                "flex items-center gap-3 rounded-xl px-4 py-3 font-medium transition-all hover:bg-sky-50",
            ...
            <div className="mt-auto">
                <Link
                    href="/scan"
                    className="flex w-full items-center justify-center gap-2 rounded-2xl bg-sky-600 py-4 font-bold text-white shadow-lg shadow-sky-500/20 transition-all hover:bg-sky-500 active:scale-95"
                >
